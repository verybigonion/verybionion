...
nz=256;
nx=256*3;
kmean_num_first = 4; %for main group clustering
kmean_num_second = 4; % for sub group clustering
...
filter = fspecial('gaussian',smooth_filter_size);
...
vp_true=dlmread('true_Marmousi256x768.dat');
