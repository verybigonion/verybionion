...
parser.add_argument("--max_epochs", type=int, default=3400, help="number of training epochs")
...
parser.add_argument("--store_weights_freq", type=int, default=3400, help="Store the trained weights every # total steps")
...
parser.add_argument("--mean_vp", type=float, default=2500, help="mean P-wave velocity")
parser.add_argument("--max_vs", type=float, default=2000, help="maximum S-wave velocity")
parser.add_argument("--mean_vs", type=float, default=1600, help="mean S-wave velocity")
parser.add_argument("--max_rho", type=float, default=1000, help="maximum density")
parser.add_argument("--mean_rho", type=float, default=2200, help="mean density")
