...
train_model1 = dlmread(['24shots_result_generate_' num2str(1) 'th_FWI_model' '/' 'train_outputs' title_name '/export13_vp.dat']);
CNN_train1   = train_model1(1+nz*nx*0:nz*nx*1);CNN_train1 = reshape(CNN_train1,nz,nx);

train_model2 = dlmread(['24shots_result_generate_' num2str(2) 'th_FWI_model' '/' 'train_outputs' title_name '/export13_vp.dat']);
CNN_train2   = train_model2(1+nz*nx*0:nz*nx*1);CNN_train2 = reshape(CNN_train2,nz,nx);

train_model3 = dlmread(['24shots_result_generate_' num2str(3) 'th_FWI_model' '/' 'train_outputs' title_name '/export13_vp.dat']);
CNN_train3   = train_model3(1+nz*nx*0:nz*nx*1);CNN_train3 = reshape(CNN_train3,nz,nx);

train_model4 = dlmread(['24shots_result_generate_' num2str(15) 'th_FWI_model' '/' 'train_outputs' title_name '/export13_vp.dat']);
CNN_train4   = train_model4(1+nz*nx*0:nz*nx*1);CNN_train4 = reshape(CNN_train4,nz,nx);

pred_model1 = dlmread(['inversion_dataset' title_name '/' 'CNN_inversion_dataset' num2str(1)  '.dat']);
CNN_inversion1   = pred_model1(1+nz*nx*0:nz*nx*1);CNN_inversion1 = reshape(CNN_inversion1,nz,nx);

pred_model2 = dlmread(['inversion_dataset' title_name '/' 'CNN_inversion_dataset' num2str(2)  '.dat']);
CNN_inversion2   = pred_model2(1+nz*nx*0:nz*nx*1);CNN_inversion2 = reshape(CNN_inversion2,nz,nx);

pred_model3 = dlmread(['inversion_dataset' title_name '/' 'CNN_inversion_dataset' num2str(3)  '.dat']);
CNN_inversion3   = pred_model3(1+nz*nx*0:nz*nx*1);CNN_inversion3 = reshape(CNN_inversion3,nz,nx);

pred_model4 = dlmread(['inversion_dataset' title_name '/' 'CNN_inversion_dataset' num2str(15)  '.dat']);
CNN_inversion4   = pred_model4(1+nz*nx*0:nz*nx*1);CNN_inversion4 = reshape(CNN_inversion4,nz,nx);
...
text(2.03658536585374, 279.841463414634,['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
...
caxis([1.5 4.5]);  
ylabel('Depth (km)');
rms_error=R2(orig_rtm_image,CNN_inversion1); 
text(2.03658536585374, 279.841463414634,['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
...
caxis([1.5 4.5]);  
%     ylabel('Depth (km)');
rms_error=R2(orig_rtm_image,CNN_inversion2); 
text(2.03658536585374, 279.841463414634,['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
text(47.2701612903226, 324.891129032259,['2nd iteration'])
disp(['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
...
caxis([1.5 4.5]);  
%     ylabel('Depth (km)');
rms_error=R2(orig_rtm_image,CNN_inversion3); 
text(2.03658536585374, 279.841463414634,['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
text(47.2701612903226, 324.891129032259,['3rd iteration'])
disp(['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
...
caxis([1.5 4.5]);  
%     ylabel('Depth (km)');
rms_error=R2(orig_rtm_image,CNN_inversion4); 
text(2.03658536585374, 279.841463414634,['Correlation coefficient =  ' num2str(rms_error, '%4.2f')])
...
plot(orig_rtm_image(:,x_position),depth,'k','LineWidth',1.5);hold on;
plot(orig_vp_smooth(:,x_position),depth,'k--','LineWidth',1.5);hold on;
plot(CNN_train1(:,x_position),depth,'b','LineWidth',1.5);hold on;
plot(CNN_inversion1(:,x_position),depth,'r','LineWidth',1.5);hold off;
...
plot(CNN_inversion2(:,x_position),depth,'r','LineWidth',1.5);hold off;
set(gca,'YDir','reverse')
xlabel('Velocity (km/s)')
set(gca,'ytick',[]) 
set(gca,'xtick',1.5:1.0:4.7) 
...
plot(CNN_inversion3(:,x_position),depth,'r','LineWidth',1.5);hold off;
set(gca,'YDir','reverse')
xlabel('Velocity (km/s)')
set(gca,'ytick',[]) 
set(gca,'xtick',1.5:1.0:4.7) 
...
plot(CNN_inversion4(:,x_position),depth,'r','LineWidth',1.5);hold off;
set(gca,'YDir','reverse')
xlabel('Velocity (km/s)')
set(gca,'ytick',[]) 
set(gca,'xtick',1.5:1.0:4.7) 
...
text(1.8, 4.15776505576208, '2nd iteration')
...
text(1.8, 4.15776505576208, '3rd iteration')
