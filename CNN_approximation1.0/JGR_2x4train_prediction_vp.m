...
orig_data = dlmread([num2str(1) 'CNN_results' '/' 'real_outputs' title_name '/real0_vp.dat'])/1000;
...
train_model1 = dlmread([num2str(1) 'CNN_results' '/' 'train_outputs' title_name '/export13_vp.dat'])/1000;
CNN_train1   = train_model1(1+nz*nx*3:nz*nx*4);CNN_train1 = reshape(CNN_train1,nz,nx);

train_model2 = dlmread([num2str(5) 'CNN_results' '/' 'train_outputs' title_name '/export13_vp.dat'])/1000;
CNN_train2   = train_model2(1+nz*nx*3:nz*nx*4);CNN_train2 = reshape(CNN_train2,nz,nx);

train_model3 = dlmread([num2str(10) 'CNN_results' '/' 'train_outputs' title_name '/export13_vp.dat'])/1000;
CNN_train3   = train_model3(1+nz*nx*3:nz*nx*4);CNN_train3 = reshape(CNN_train3,nz,nx);

train_model4 = dlmread([num2str(19) 'CNN_results' '/' 'train_outputs' title_name '/export13_vp.dat'])/1000;
CNN_train4   = train_model4(1+nz*nx*3:nz*nx*4);CNN_train4 = reshape(CNN_train4,nz,nx);

pred_model1 = dlmread([num2str(1) 'CNN_results' '/' 'real_outputs' title_name '/real0_vp.dat'])/1000;
CNN_test1   = pred_model1(1+nz*nx*3:nz*nx*4);CNN_test1 = reshape(CNN_test1,nz,nx);

pred_model2 = dlmread([num2str(5) 'CNN_results' '/' 'real_outputs' title_name '/real0_vp.dat'])/1000;
CNN_test2   = pred_model2(1+nz*nx*3:nz*nx*4);CNN_test2 = reshape(CNN_test2,nz,nx);

pred_model3 = dlmread([num2str(10) 'CNN_results' '/' 'real_outputs' title_name '/real0_vp.dat'])/1000;
CNN_test3   = pred_model3(1+nz*nx*3:nz*nx*4);CNN_test3 = reshape(CNN_test3,nz,nx);

pred_model4 = dlmread([num2str(19) 'CNN_results' '/' 'real_outputs' title_name '/real0_vp.dat'])/1000;
