...
plot(vp_true_real(:,x_position),depth,'k','LineWidth',1.5);hold on;
plot(vp_true(:,x_position),depth,'r','LineWidth',1.5);hold off;
set(gca,'YDir','reverse')
xlabel('Amplitude')
ylabel('Depth (km)')
set(gca,'ytick',[1 nz/4 nz/2 nz/4*3 nz]*dh) 
set(gca,'xtick',1.5:0.5:5.0) 
set(gca,'xticklabel',sprintf('%3.1f|',get(gca,'xtick')))
set(gca,'yticklabel',sprintf('%3.1f|',get(gca,'ytick')))
axis([1.5 5.0 0 (nz-1)*dh])
set(gca,'XAxisLocation','top');
