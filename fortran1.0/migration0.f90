  program vesou2d
  implicit none
  character(len=100)::model_in='given_models0/'
...
write(filenumber_iteration,'(i5)')shot_num
open(10, file='./output0/Fortran_rtm'//trim(adjustl(filenumber_iteration))//'.dat')
close(10,status='delete')
open(10, file='./output0/Fortran_rtm'//trim(adjustl(filenumber_iteration))//'.dat',status='new'& 
